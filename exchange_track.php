...
try {
    ...
    if ($userId) {
        ...
        $stmt = $pdo->prepare("SELECT partage.*, proposeur.username as proposeur_username, receveur.username as receveur_username, 
                                      deck_propose.nom as deck_propose_nom, deck_demande.nom as deck_demande_nom,statut as statut
                               FROM partage
                               ...
                               WHERE partage.proposeurID = :userId ");
            ...
            <?php if (!empty($demandes)): ?>
                <?php foreach ($demandes as $demande): ?>
                    <div class="deck-item">
                        ...
                        <p>etat d'avencement : <?php echo htmlspecialchars($demande['statut']); ?></p>
